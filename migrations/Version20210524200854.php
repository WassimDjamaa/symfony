 ...
 */
final class Version20210524200854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, id_questions_id INT DEFAULT NULL, id_users_id INT DEFAULT NULL, answer_id INT NOT NULL, adress_ip VARCHAR(255) DEFAULT NULL, INDEX IDX_136AC1139F7041BC (id_questions_id), INDEX IDX_136AC113376858A8 (id_users_id), INDEX IDX_136AC113AA334807 (answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
